...
This file provides guidance to Claude Code (claude.ai/code) when working with code in this repository (`'/Users/danieltan/blockchain crowdfunding platform (1)'` if Claude Code is in a different reppository such as `/Users/danieltan/StartupFund`).
